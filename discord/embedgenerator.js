...
module.exports = class EmbedGenerator {
	...
	fairTeam(CONFIG, region, summoners, ranks, masteries) {
		...
		team_by_level_team_0_description += "Min: `" + team_by_level[team_by_level_best].min[0] + "`\nMax: `" + team_by_level[team_by_level_best].max[0] + "`\nμ: `" + UTILS.round(team_by_level[team_by_level_best].avg[0], 2) + " σ: " + UTILS.round(team_by_level[team_by_level_best].stdev[0], 2) + "∑: " + team_by_level[team_by_level_best].sum[0] + "Δ: " + team_by_level[team_by_level_best].abs;
		team_by_level_team_1_description += "Min: `" + team_by_level[team_by_level_best].min[1] + "`\nMax: `" + team_by_level[team_by_level_best].max[1] + "`\nμ: `" + UTILS.round(team_by_level[team_by_level_best].avg[1], 2) + " σ: " + UTILS.round(team_by_level[team_by_level_best].stdev[1], 2) + "∑: " + team_by_level[team_by_level_best].sum[1] + "Δ: " + team_by_level[team_by_level_best].abs;
