...
module.exports = function (CONFIG, client, msg, wsapi, sendToChannel, preferences, ACCESS_LEVEL, server_RL, user_RL) {
	...
	function printMessage(x = "") {
		if (!msg.PM) UTILS.output(x + "\n" + ctable.getTable([{ content: msg.cleanContent, author: msg.author.tag, P: ACCESS_LEVEL, channel: msg.channel.name, guild: msg.guild.name }, { content: msg.id, author: msg.author.id, channel: msg.channel.id, guild: msg.guild.id }]));
		else UTILS.output(x + "\n" + ctable.getTable([{ content: msg.cleanContent, author: msg.author.tag, P: ACCESS_LEVEL, channel: msg.channel.name }, { content: msg.id, author: msg.author.id, channel: msg.channel.id }]));
